  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -left-20 top-10 h-72 w-72 rounded-full bg-red-400/25 blur-3xl" />
        <div className="absolute right-0 top-24 h-80 w-80 rounded-full bg-[#6f1d2f]/22 blur-3xl" />
        <div className="absolute bottom-0 left-1/2 h-64 w-[32rem] -translate-x-1/2 rounded-full bg-[#8b1e3f]/24 blur-3xl" />
        <motion.div
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-3xl items-center justify-center">
        <div className="glass-panel relative w-full rounded-[2rem] px-6 py-12 text-center sm:px-10 sm:py-16">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.4em] text-red-700/80">
            A little surprise
          </p>
          ...
          <div className="mt-10 flex items-center justify-center">
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              onClick={onContinue}
              className="group relative inline-flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-red-700 via-[#8b1e3f] to-[#5f1725] shadow-[0_20px_60px_rgba(122,31,54,0.35)] ring-8 ring-white/60 transition-shadow duration-300 hover:shadow-[0_26px_70px_rgba(122,31,54,0.42)]"
            >
